...
// initialize our map
var map = L.map('map', {
	center: [51.83141507434949, 19.261865615844723],
...
var sourceMarker = L.marker([51.83141507434949, 19.261865615844723], {
	draggable: true
})
...
var targetMarker = L.marker([51.83181507434949, 19.268865615844723], {
	draggable: true
})
	.on("dragend", function(e) {
		selectedPoint = e.target.getLatLng();
